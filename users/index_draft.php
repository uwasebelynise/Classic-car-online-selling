...
<div class="container">
    ...
    <div class="row">
    <h2 class="text-dark bg-light btn" id="Home"><span class=" icon_profile"></span>Welcome  <?php echo $_SESSION['login']['username']?>   |   <?php echo $_SESSION['login']['names']?></h2> 
            ...
            <a href="xorder.php?car_id=<?php echo $row['car_id'];?>" class="btn btn-outline-light <?php echo $dis ; ?>" name="submit">Order</a>
             <ul class="d-flex list-unstyled mt-auto">
              ...
              <li class="d-flex align-items-center">
                ...
                <small>Quantity:<?php echo $row['quantity'] ; ?></small>
              </li>
            </ul>
          </div>
      </div>
...
<div class="container px-4 py-5" id="Pricing" id="custom-cards Pricing">
    <h2 class="pb-2 border-bottom">Pickup cars</h2>
    ...
    <?php 
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('../img/<?php echo $row['avatar'] ; ?>');">
          <div class="jjo d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
          <h2 class="text-danger display-5 lh-1 fw-bold"><?php echo $show ; ?></h2>
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"><?php echo $row['name'] ; ?></h2>
            <a href="xorder.php?car_id=<?php echo $row['car_id'];?>" class="btn btn-outline-light <?php echo $dis ; ?>" name="submit">Order</a>
             <ul class="d-flex list-unstyled mt-auto">
              <li class="me-auto">
    ...
    <?php 
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('../img/<?php echo $row['avatar'] ; ?>');">
          ...
          <h2 class="text-danger display-5 lh-1 fw-bold"><?php echo $show2 ; ?></h2>
            <h2 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold"><?php echo $row['name'] ; ?></h2>
            <a href="xorder.php?car_id=<?php echo $row['car_id'];?>" class="btn btn-outline-light <?php echo $dis ; ?>" name="submit">Order</a>
             <ul class="d-flex list-unstyled mt-auto">
              <li class="me-auto">
  ...
  <div class="container px-4 py-5" id="custom-cards">
    <h2 class="pb-2 border-bottom">Track cars</h2>
...
<div class="container" id="About">
  <footer class="py-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <h5>Location</h5>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15942.689092301473!2d29.7316661!3d-2.6122564500000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2srw!4v1679515636195!5m2!1sen!2srw" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
