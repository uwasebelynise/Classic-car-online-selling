  ...
  <div class="row py-5 px-5" style="width:100%;">
    <div class="card main-content">
     ...
     <table class="table table-responsive">
      ...
      <?php 
              $no = 1;
              $sel=$mysqli->query("select * from cars");
              while ($row=mysqli_fetch_array($sel)) {
                ...
                <tr>
                  ...
                  <td><div class="btn-group btn-default">
                    <a href="../includes/delete.php?car_id=<?php echo $row['car_id'];?>" class="btn btn-danger" name="submit">Delete</a>
                    <a href="update.php?car_id=<?php echo $row['car_id'];?>" class="btn btn-secondary" name="submit">Update</a>
                  </div></td>
