  ...
  <div class="row py-5 px-5" style="width:100%;">
    <div class="card">
     ...
     <table class="table table-striped">
      ...
      <?php 
              $no = 1;
              $sel=$mysqli->query("select * from cars,users,orders where orders.car_id = cars.car_id and orders.user_id = users.user_id") or die(mysqli_error($mysqli)) ;
              while ($row=mysqli_fetch_array($sel)) {
                ...
                <tr>
                  ...
                  <td><div class="btn-group btn-default">
                    <a href="xconfirm.php?order_id=<?php echo $row['order_id'];?>" class="btn btn-secondary" name="submit">Confirm</a>
                  </div></td>
